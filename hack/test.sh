...
if [[ "${SOURCE_PATH}" != *"src/github.com/23technologies/gardener-extension-provider-ionos" ]]; then
  SOURCE_SYMLINK_PATH="${SOURCE_PATH}/tmp/src/github.com/23technologies/gardener-extension-provider-ionos"
