...
import (
	ionoswebhook "github.com/23technologies/gardener-extension-provider-ionos/pkg/webhook/controlplane"
...
func webhookSwitchOptions() *webhookcmd.SwitchOptions {
	return webhookcmd.NewSwitchOptions(
		webhookcmd.Switch(webhook.WebhookName, ionoswebhook.AddToManager),
	)
}
