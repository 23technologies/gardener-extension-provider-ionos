...
import (
	"github.com/23technologies/gardener-extension-provider-ionos/pkg/ionos/apis/config"
	"github.com/23technologies/gardener-extension-provider-ionos/pkg/ionos/apis/config/v1alpha1"
