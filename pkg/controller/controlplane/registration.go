...
import (
	...
	controllerapis "github.com/23technologies/gardener-extension-provider-ionos/pkg/ionos/apis/controller"
...
var (
	...
	logger = log.Log.WithName("ionos-controlplane-controller")
)

// AddOptions are options to apply when adding the IONOS controlplane controller to the manager.
